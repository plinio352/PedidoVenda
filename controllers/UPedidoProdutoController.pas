...
begin
   ...
   try
      for obj in Value do
      begin
         if dmVenda.qryPedidoProduto.Locate('numero_pedido', obj.numeroPedido.numeroPedido, [loCaseInsensitive]) then begin

            obj.valorTotal := obj.quantidade * obj.valorUnitario;

            dmVenda.qryPedidoProduto.Edit;
            dmVenda.qryPedidoProduto.FieldByName('numero_pedido').Value    := obj.numeroPedido.numeroPedido;
            dmVenda.qryPedidoProduto.FieldByName('codigo_produto').Value   := obj.codigoProduto.codigo;
            dmVenda.qryPedidoProduto.FieldByName('quantidade').Value       := obj.quantidade;
            dmVenda.qryPedidoProduto.FieldByName('valor_unitario').Value   := obj.valorUnitario;
            dmVenda.qryPedidoProduto.FieldByName('valor_total').Value      := obj.valorTotal;
